...
router.put(`/listings/:id`, (req, res) => {
    ...
    db(`UPDATE INTO listings (user_id, date_published, space_type, is_shared, location_id) VALUES ('${req.body.user_id}', '${req.body.date_published}', '${req.body.space_type}', '${req.body.is_shared}', '${req.body.location_id}');`)
        .then(results => {
            if (results.error)
            {
